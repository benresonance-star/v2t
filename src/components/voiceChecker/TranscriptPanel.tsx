    ...
    <div className="flex flex-col gap-[25px]">
      <div className="!p-12 glass-panel rounded-[2rem] flex flex-col gap-8">
        <div className="space-y-4">
          ...
          <div className="text-zinc-100 text-[18px] leading-relaxed min-h-[50px] font-normal p-12 mx-[25px] mb-[25px] glass-inner rounded-[1.5rem]">
            {isTranscribing ? (
      ...
      {/* Accuracy Section */}
      <div className="!p-24 glass-panel rounded-[2rem] flex flex-col gap-8">
        <div className="flex justify-between items-end px-[25px]">
        ...
        <div className="mx-[25px] h-[4px] bg-zinc-900 rounded-full overflow-hidden relative">
          <motion.div
            initial={{ width: 0 }}
